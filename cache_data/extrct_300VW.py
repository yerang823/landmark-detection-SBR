...
def generate_extract_300vw(P300VW):
  ...
  assert len(alldirs) == 13, 'The directories of 300VW should be 114 not {}'.format(len(alldirs))
  cmds = []
  for xdir in alldirs:
...
if __name__ == '__main__':
  ...
  P300VW = osp.join('/app/landmark-detection/SBR2/datasets/landmark-datasets/300VW_Dataset_2015_12_14')
